...
| Testing requirements | 17. Testing | Must | Partial | ALT-014,ALT-022,ALT-026,ALT-028,ALT-029,ALT-035 | `cargo test` passes the current suite, including integration-style Git/review tests and binary-level E2E tests for auth, sessions, agent, MCP, tools, perf, large-repository file operations, and long-session persistence. Fixed-toolchain core coverage is measured at 81.12% with CI coverage gating; full interactive TUI/E2E coverage still requires more evidence. |
