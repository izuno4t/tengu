...
| Testing requirements | 17. Testing | Must | Partial | ALT-014,ALT-022,ALT-026 | `cargo test` passes the current suite, including integration-style Git/review tests. Coverage target and broader E2E tests require more evidence. |
