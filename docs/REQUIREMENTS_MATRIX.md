...
| Built-in tools and definitions | 4.1 Built-in Tools | Must | Partial | ALT-014,ALT-016 | Read, Write, Shell, Grep, and Glob exist. WebFetch and WebSearch are missing. Tool schema documentation is not generated from the tool registry. |
