...
- `src/` contains Rust sources. Key modules: `agent/`, `cli.rs`, `config/`,
  `llm/`, `mcp/`, `session/`, `tools/`, `tui/`, `main.rs`.
...
- For implementation work, refer to `docs/RUST_CODING_GUIDELINES.md`.

## Git Operations

- For Git operations, refer to `docs/GIT_RULE.md`.
...
- Update `docs/TASK.md` task statuses when completing tasks.
...
- PRs should include a clear summary, link related Issues, and update
  docs/tests when needed.
